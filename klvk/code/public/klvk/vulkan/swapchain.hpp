...
public:
    ...
    [[nodiscard]] vk::SwapchainKHR GetHandle() const noexcept { return swapchain_.get(); }
    ...
    [[nodiscard]] vk::ImageView GetImageView(size_t index) const override { return image_views_[index].get(); }
