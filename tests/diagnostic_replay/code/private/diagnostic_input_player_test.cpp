...
public:
    static void Run()
    {
        ...
        {
            DiagnosticInputRecorder recorder(recording_path, application.GetEventManager(), window->GetCursorPos());
        ...
        tests::Ensure(
            recording.initial_cursor_position == window->GetCursorPos(),
            "text recording lost the initial cursor position");
